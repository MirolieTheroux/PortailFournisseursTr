...
return [
    ...
    */
    ...
    'between' => [
        ...
        'string' => 'La chaine de caractères :attribute doit contenir entre :min et :max caractères.',
    ],
    ...
    'doesnt_end_with' => 'Le champ :attribute ne doit pas terminer par l\'une des valeurs suivante: :values.',
    'doesnt_start_with' => 'Le champ :attribute ne doit pas commencer par l\'une des valeurs suivante: :values.',
    'email' => 'Le champ :attribute doit être un adresse courriel valide.',
    'ends_with' => 'Le champ :attribut doit terminer par l\'une des valeurs suivante: :values.',
    ...
    'gt' => [
        ...
        'string' => 'La chaine de caractères :attribute doit contenir plus que :value caracteres.',
    ],
    'gte' => [
        ...
        'string' => 'La chaine de caractères :attribute doit contenir :value caractères ou plus.',
    ],
    ...
    'lt' => [
        ...
        'string' => 'La chaine de caractères :attribute doit contenir moins que :value caractères.',
    ],
    'lte' => [
        ...
        'string' => 'La chaine de caractères :attribute doit contenir :value caractères ou moins.',
    ],
    ...
    'max' => [
        ...
        'string' => 'La chaine de caractères :attribute ne doit pas contenir plus que :max caractères.',
    ],
    ...
    'min' => [
        ...
        'file' => 'Le fichier :attribute doitavoir une taille d\'au moins :min kilobytes.',
        'numeric' => 'Le nombre :attribute doit être d\'au moins :min.',
        'string' => 'La chaine de caractères :attribute doit contenir au moins :min caractères.',
    ],
    ...
    'size' => [
        ...
        'string' => 'La chaine de caractères :attribute doit être de :size caractères.',
    ],
