    ...
    <table align="center" width="600" style="border: 1px solid #dddddd; border-radius: 5px; padding: 20px;">
        ...
        <tr>
            <td align="center">
                ...
                <p style="font-size: 16px;">
                    En attendant, n'hésitez pas à explorer notre portail pour en savoir plus sur les opportunités de collaboration avec la Ville de Trois-Rivières.
                </p>
            </td>
        </tr>
        <tr>
            <td align="center" style="padding: 20px;">
                <p style="font-size: 14px; color: #666666;">
                    Merci de votre intérêt et de votre patience.<br>
                    L'équipe de la Ville de Trois-Rivières
                </p>
            </td>
        </tr>
        <tr>
