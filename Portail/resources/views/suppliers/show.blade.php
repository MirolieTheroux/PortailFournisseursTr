...
<div class="w-100 border-top border-dark">
  ...
  <div class="hamburger-nav col-12 text-center">
    ...
    <div id="identification-hamburger-button" class="hamburger-button py-1 rounded">
    ...
    <div id="contactDetails-hamburger-button" class="hamburger-button py-1 rounded">
    ...
    <div id="contacts-hamburger-button" class="hamburger-button py-1 rounded">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="m-2">
    ...
    <div id="productsServices-hamburger-button" class="hamburger-button py-1 rounded">
    ...
    <div id="licence-hamburger-button" class="hamburger-button py-1 rounded">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="m-2">
    ...
    <div id="attachments-hamburger-button" class="hamburger-button py-1 rounded">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512" class="m-2">
    ...
    <div id="finances-hamburger-button" class="hamburger-button py-1 rounded">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="m-2">
