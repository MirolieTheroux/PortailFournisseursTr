  ...
  @foreach ($suppliers as $supplier)
    <div class="row supplier-table mx-0 py-1">
      ...
      <div class="col-1 d-flex px-1">
        ...
        <div class="text-center supplier-list-table-text text-accepted ps-1">{{__('index.accepted')}}</div>
        ...
        <div class="text-center supplier-list-table-text text-waiting ps-1">{{__('index.waiting')}}</div> --}}
        ...
        <div class="text-center supplier-list-table-text text-refused ps-1">{{__('index.denied')}}</div> --}}
        ...
        <div class="text-center supplier-list-table-text text-to-review ps-1">{{__('index.toCheck')}}</div> --}}
      </div>
