...
<div class="container-fluid d-flex flex-column h-100">
  <div class="row h-100">
    ...
    <div class="d-none d-lg-flex left-nav shadow-sm col-3 col-xl-2 bg-white h-100 flex-column justify-content-start">
      <div id="login-nav-button" class="text-start rounded px-3 py-1 mt-2 doc-nav-button">{{__('documentation.suppliersList')}}</div>
      <div id="signup-nav-button" class="text-start rounded px-3 py-1 mt-2 doc-nav-button">{{__('documentation.supplierZoom')}}</div>
      <div id="home-nav-button" class="text-start rounded px-3 py-1 mt-2 doc-nav-button">{{__('documentation.selectedsuppliersList')}}</div>
